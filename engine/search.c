...
//	DEB_SE( char b2[256];)
	...
	DEB_S2( mvs.alfa=alfa; mvs.beta=beta; mvs.def.state=0; mvs.def.real_score=-mb->real_score; )
...
bypass:
		DEB_S2(m->a=talfa; m->b=tbeta; m->re=extend-reduce; )
