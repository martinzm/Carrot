...
// pieces
	K_OR_M = 0U, P_OR = 1U, N_OR = 2U, B_OR = 3U, R_OR = 4U, Q_OR = 5U, K_OR = 6U, 
	MV_UND = 100U, A_CA_PROM_N = 109U,
	MV_BAD = 240U, MV_BAD_MAX = 349U,
	MV_OR = 350U, MV_OR_MAX = 359U,
	MV_HH_MIN=401, MV_HH = 16800U, MV_HH_MAX = 33199,
	CS_K_OR = 33200U, CS_Q_OR = 33201U,
	KILLER_OR = 33210U, KILLER_OR_MAX = 33219U,
	CHECK_QUI = 33220U,
	A_OR2 = 33300U, A_OR2_MAX = 33359U,
	A_OR_N = 33360U, A_OR_N_MAX = 33439U,
	A_OR = 33440U, A_OR_MAX = 33539U,
	A_CA_PROM_Q = 33540U,
	HASH_OR = 33550U,
	PV_OR = 33551U
		
//	A_MINOR_PROM = 5000U, A_KNIGHT_PROM = 10400U,
//	A_QUEEN_PROM = 10500U
...
#define SHELTERH7  0x00E0E00000000000ULL
#define SHELTERM7  0X0038380000000000ULL
#define SHELTERA2  0x0000000000070700ULL
#define SHELTERH2  0x0000000000E0E000ULL
#define SHELTERM2  0x0000000000383800ULL
// abc 0x07
// fgh 0xE0
// def 0x38
// cdef 0x3C
#define SHELTERA  0x0007070707070700ULL
#define SHELTERH  0x00E0E0E0E0E0E000ULL
#define SHELTERM  0X0038383838383800ULL
